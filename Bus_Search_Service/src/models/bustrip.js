    ...
    BusTrip.init(
      {
        ...
        viaRoutes: {
          ...
          defaultValue: "[]",
          get() {
            const value = this.getDataValue("viaRoutes");
            return value ? JSON.parse(value) : [];
          },
          set(value) {
            this.setDataValue("viaRoutes", JSON.stringify(value));
          },
        },//store city ids 
        viaStops: {
          type: DataTypes.TEXT,
          ...
          defaultValue: "[]",
          get() {
            const value = this.getDataValue("viaStops");
            return value ? JSON.parse(value) : [];
          },
          set(value) {
            this.setDataValue("viaStops", JSON.stringify(value));
          },
        },//store station ids 
        ticketPrice: {
